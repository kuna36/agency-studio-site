  ...
  return (
    <div className="site-shell noise">
      ...
      <main>
        ...
        <section className="section-tight border-b border-white/[.06] bg-[#e8edf5]">
        ...
        <section id="services" className="section border-b border-white/[.06] bg-[#e8edf5]">
        ...
        <section id="work" className="section border-b border-white/[.06] bg-[#e8edf5]">
        ...
        <section id="about" className="section border-b border-white/[.06] bg-[#e8edf5]">
        ...
        <section className="section border-b border-white/[.06] bg-[#e8edf5]">
