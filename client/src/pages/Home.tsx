  ...
  return (
    <div className="site-shell noise">
      ...
      <main>
        ...
        <section className="section-tight border-b border-white/[.06] bg-[#1a102a]">
        ...
        <section id="solutions" className="section border-b border-white/[.06]">
          <div className="container-wide"><Reveal><SectionLabel index="03">From unclear to actionable</SectionLabel><div className="grid gap-8 md:grid-cols-[1fr_.72fr] md:items-end"><h2 className="section-title max-w-[680px] text-white">You bring the idea.<br /><span className="text-slate-500">We handle the technology.</span></h2><p className="body-copy max-w-[350px]">A good project starts with a conversation in plain language. Here is what that transformation can look like.</p></div></Reveal><div className="mt-14 grid gap-3">{site.problems.map(([problem, solution, detail], index) => <Reveal key={problem} delay={`delay-${(index % 3) + 1}`}><div className="problem-flow data-flow glass-card px-5 py-5 sm:px-7"><div className="flex items-center gap-4"><span className="mono text-[10px] text-slate-600">0{index + 1}</span><p className="text-sm text-slate-200">{problem}</p></div><div className="flow-arrow"><ArrowRight size={15} /></div><div className="flex items-center justify-between gap-4"><div><p className="text-sm font-bold text-cyan-200">{solution}</p><p className="mt-1 text-xs text-slate-500">{detail}</p></div><Check size={16} className="shrink-0 text-cyan-200/70" /></div></div></Reveal>)}</div></div>
        </section>

        <section id="services" className="section border-b border-white/[.06] bg-[#1a102a]">
        ...
        <section id="about" className="section border-b border-white/[.06] bg-[#1a102a]">
        ...
        <section className="section border-b border-white/[.06] bg-[#1a102a]">
